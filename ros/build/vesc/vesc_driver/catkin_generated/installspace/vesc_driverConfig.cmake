...
if("FALSE" STREQUAL "TRUE")
  set(vesc_driver_SOURCE_PREFIX /home/nathan/f1-autonomous/ros/src/vesc/vesc_driver)
  set(vesc_driver_DEVEL_PREFIX /home/nathan/f1-autonomous/ros/devel)
  ...
  set(vesc_driver_INSTALL_PREFIX /home/nathan/f1-autonomous/ros/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vesc_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nathan/f1-autonomous/ros/install/${idir}'.  ${_report}")
    endif()
